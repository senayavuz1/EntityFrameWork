...
namespace WinDbFirst
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual DbSet<UrunlereGoreDagilim> UrunlereGoreDagilim { get; set; }
        public virtual DbSet<UrunlereGoreDagilim2> UrunlereGoreDagilim2 { get; set; }
        ...
        public virtual ObjectResult<CalisanlarinYillarGoreDagilimi_Result> CalisanlarinYillarGoreDagilimi(Nullable<int> yil)
        {
            var yilParameter = yil.HasValue ?
                new ObjectParameter("yil", yil) :
                new ObjectParameter("yil", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<CalisanlarinYillarGoreDagilimi_Result>("CalisanlarinYillarGoreDagilimi", yilParameter);
        }
        ...
        public virtual ObjectResult<EnBuyuk_Result> EnBuyuk()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<EnBuyuk_Result>("EnBuyuk");
        }
