...
namespace NorthWindCoreEf.Entities
{
    public partial class NorthWindDbContext : DbContext
    {
        ...
        public virtual DbSet<UrunlereGoreDagilim> UrunlereGoreDagilims { get; set; }
        public virtual DbSet<UrunlereGoreDagilim2> UrunlereGoreDagilim2s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UrunlereGoreDagilim>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("UrunlereGoreDagilim");
            ...
            modelBuilder.Entity<UrunlereGoreDagilim2>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("UrunlereGoreDagilim2");
