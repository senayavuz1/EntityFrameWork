...
{
    public partial class VwRprSaSipari
    {
        ...
        public string Sipariseden { get; set; }
        public string Simge { get; set; }
        public double? Oran { get; set; }
        public double? Uruneni { get; set; }
        public double? Urunboyu { get; set; }
        public double? BicakBoy { get; set; }
        public double? BicakEn { get; set; }
    }
}
